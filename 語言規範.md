...
```
and, any, await, bool, const, copy, else, error, extends, false, float, fn, for, if, in, int, interface, is_error, len, list, main, map, not, optional, or, ptr, print, println, return, sleep, spawn, string, struct, true, tuple, union, unsafe, while, override
```
